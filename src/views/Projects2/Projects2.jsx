...
export default function Projects2() {
  return (
    <div className="bg-sky-800" id="projects">
      <div className="snap-start bg-project2 bg-center bg-cover bg-opacity-20 h-screen w-screen flex flex-col">
        <div className="flex flex-col align-middle justify-center items-center">
          ...
          <p className="text-white text-md text-center w-1/2 mt-4 mb-8 text-shadow-md align-middle justify-center">
            GoodJob.dev is a an application with{' '}
        ...
        <div className="bg-goodjob h-full w-full bg-no-repeat bg-center bg-contain mb-20"></div>
      </div>
    </div>
  );
}
